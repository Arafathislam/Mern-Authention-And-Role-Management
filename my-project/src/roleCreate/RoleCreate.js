          ...
          <form className="max-w-sm mx-auto">
            ...
            <div className='flex gap-2'>
                ...
                <div className={`z-10 ${isDropdownOpen ? 'block' : 'hidden'} bg-white rounded-lg shadow w-60 absolute`}>
                  ...
                  <ul className="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-700 " aria-labelledby="dropdownSearchButton">
                    ...
                    <li>
                      <div className="flex items-center ps-2 rounded hover:bg-gray-100">
                        <input id="checkbox-item-17" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500    focus:ring-2 " />
                        <label for="checkbox-item-17" className="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded d">arnob</label>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="flex items-center ps-2 rounded hover:bg-gray-100">
                        <input id="checkbox-item-17" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500    focus:ring-2 " />
                        <label for="checkbox-item-17" className="w-full py-2 ms-2 text-sm font-medium text-gray-900 rounded d">arif</label>
                      </div>
                    </li>
              ...
              <div className='mt-1 flex gap-1'>
                 ...
                 {/* chips start  */}
                <span id="badge-dismiss-dark" class="inline-flex items-center px-2 py-1 me-2 text-sm font-medium text-gray-800 bg-gray-100 rounded ">
                  arafath
                  <button type="button" class="inline-flex items-center p-1 ms-2 text-sm text-gray-400 bg-transparent rounded-sm hover:bg-gray-200 hover:text-gray-900 " data-dismiss-target="#badge-dismiss-dark" aria-label="Remove">
            ...
            <div className='flex gap-2 mt-2 justify-center items-center '>
              ...
              <div>
                ...
                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                  ...
                  <option value="FR">Editor</option>
                  <option value="DE">Modulator</option>
                </select>
